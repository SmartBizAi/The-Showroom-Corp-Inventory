...
- Facebook Marketplace NO tiene API para dealers: solo publicación asistida con humano en el loop (ver "Estrategia de 3 carriles" en PLAN.md). Nunca bots headless ni almacenar contraseñas de Facebook.
